...
public class RedisUtil {
    ...
    public Object getObj(String key) {
        Desk value =JSON.parseObject(redisTemplate.opsForValue().get(key), Desk.class);
        return value;
    }
    ...
    public List getList(String key) {
        ...
        if("allDishes".equals(key)){
			value=JSON.parseArray(redisTemplate.opsForValue().get(key), Dish.class);
		}else{
			 value =JSON.parseArray(redisTemplate.opsForValue().get(key), DeskInfo_detail.class);
		}
        return value;
    }
