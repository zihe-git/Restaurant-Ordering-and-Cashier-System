		...
		<div class="adjust-nav">
			<div class="navbar-header">
				<button type="button" class="navbar-toggle" data-toggle="collapse"
				 ...
				 <a class="navbar-brand" href="${pageContext.request.contextPath}/desklist.html"> 
				</a>
			</div>
	...
	<nav class="navbar-default navbar-side" role="navigation">
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				<li>
				<a href="${pageContext.request.contextPath}/desklist.html?show=desk"
					<c:if test="${param.show=='desk' }">class="active-link"</c:if>>
					<i class="fa fa-desktop "></i>桌位
				</a>
				</li>
				<%-- <li><a
					href="${pageContext.request.contextPath}/bill.html?show=bill"
