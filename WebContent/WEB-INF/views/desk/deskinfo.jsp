						...
						<td colspan="6">
							<ul class="pager">
								...
								<li class="next"><a class="btn btn-warning " id="diancai" style="background-color: #D9534F; color:#FFFFFF;">
										点菜 </a>
									<a class="btn btn-warning"  style="background-color: deepskyblue; color:#FFFFFF;" id="print">
										打印 </a>
		...
		<div class="col-xs-5 panel panel-info" style="height:750px;">
			<div class="panel-body">
				<ul class="nav nav-tabs ">
					...
					<li><a href="#fry" data-toggle="tab">主食类</a></li>
					<li><a href="#veg" data-toggle="tab">小菜</a></li>
								...
								<div class="form-group has-success">
									<div class="input-group has-success">
										<span class="input-group-addon "> 挂账 </span> <input
											type="text" class="form-control debtorInput" id="onAccount"
											disabled="disabled">
									</div>
									<!-- /input-group -->
								</div>
